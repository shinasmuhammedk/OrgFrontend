    ...
    return (
        <div
            style={{
                ...
                color: "#e4e4f0",
                border: selected ? "2px solid #c8ff44" : "1px solid #272738",
                borderRadius: 12,
                minWidth: 220,
        ...
        >
            <span
                style={{
                    ...
                    height: 6,
                    borderRadius: "50%",
                    background: isSuccess ? "#c8ff44" : "#ff5c7a",
                }}
            />
            {status}
        </span>
    ...
    return (
        <div
            style={{
                minHeight: "100vh",
                background:
                    "radial-gradient(circle at top left, rgba(200,255,68,0.06), transparent 30%), #09090e",
                color: "#e4e4f0",
                padding: "24px",
        ...
        >
            <style>{`
                ...
                .run-card:hover {
                    border-color: #c8ff44 !important;
                    transform: translateY(-2px);
                    box-shadow: 0 4px 20px rgba(200, 255, 68, 0.1);
                }

                .btn-primary:hover {
                    transform: translateY(-1px);
                    box-shadow: 0 4px 12px rgba(200, 255, 68, 0.3);
                }
            ...
            >
                <div>
                    ...
                    <p style={{ color: "#9898b8", fontSize: 15, lineHeight: 1.5 }}>
                        Build, save, run, and inspect your workflow
                    </p>
                </div>
                ...
                >
                    ...
                    <button
                        ...
                        style={{
                            ...
                            border: "1px solid rgba(200,255,68,0.25)",
                            borderRadius: 14,
                            padding: 16,
                            marginBottom: 14,
                            cursor: "pointer",
            ...
            {!loading && runs.length === 0 && (
                ...
                >
                    ...
                    <p style={{ fontSize: 13, opacity: 0.7 }}>
                        Click "Run Workflow" to execute your workflow
                    </p>
                </div>
            )}
                            ...
                            >
                                <div>
                                    ...
                                    <div style={historyMetaValue}>
                                        {formatDate(run.StartedAt?.Time || run.started_at)}
                                    </div>
                                </div>
            ...
            {selectedNode && (
                <div
                    style={{
                        ...
                        height: "100vh",
                        background: "#12121a",
                        borderLeft: "1px solid #272738",
                        padding: "24px",
                        overflowY: "auto",
                        zIndex: 20,
                        animation: sidebarAnimating ? "sidebarSlide 0.3s ease" : "none",
...
const activeIconBoxStyle = {
    width: 38,
    height: 38,
    borderRadius: 10,
    background: "rgba(200,255,68,0.12)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
};

const disabledIconBoxStyle = {
    width: 38,
    height: 38,
    borderRadius: 10,
    background: "#171722",
...
const paletteSubStyle = {
    color: "#9898b8",
    fontSize: 12,
};

const historyMetaLabel = {
    fontSize: 11,
    color: "#9898b8",
    textTransform: "uppercase",
    letterSpacing: "0.5px",
